...
#         z_scores=z_scores,
#         p_values=p_values,
#        #  title=f"{label}: lobe-level tau progression vs. BrainSMASH null",
...
# # If your .node file is whitespace separated and first 3 cols are x/y/z:
...
# # centered map for relative spatial prominence
...
# print("empirical_map_raw shape:", empirical_map_raw.shape)
# print("lobe_index length:", len(lobe_index))


# # ============================================================
# # 5. Run two BrainSMASH experiments
# # ============================================================
# # Experiment A: raw map
